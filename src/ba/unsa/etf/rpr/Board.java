...
public class Board {
    ...
    public Board() {
        ...
        listaFigura.add(new Rook("A8", ChessPiece.Color.BLACK));
        listaFigura.add(new Knight("B8", ChessPiece.Color.BLACK));
        listaFigura.add(new Bishop("C8", ChessPiece.Color.BLACK));
        listaFigura.add(new Queen("D8", ChessPiece.Color.BLACK));
        listaFigura.add(new King("E8", ChessPiece.Color.BLACK));
        listaFigura.add(new Bishop("F8", ChessPiece.Color.BLACK));
        listaFigura.add(new Knight("G8", ChessPiece.Color.BLACK));
        listaFigura.add(new Rook("H8", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("A7", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("B7", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("C7", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("D7", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("E7", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("F7", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("G7", ChessPiece.Color.BLACK));
        listaFigura.add(new Pawn("H7", ChessPiece.Color.BLACK));
    }

    public void move(Class type, ChessPiece.Color color, String position) {
        String staraPozicija;
        for (ChessPiece chessPiece : listaFigura) {
            if (chessPiece.getClass() == type && chessPiece.getColor() == color) {
                staraPozicija = new String(chessPiece.getPosition());
                try {
